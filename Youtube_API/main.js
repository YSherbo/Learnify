...
async function getYoutubeResults(query, resultsPerPage, pageToken) {
  ...
  let url = `https://www.googleapis.com/youtube/v3/search?key=${YOUTUBE_API_KEY}&type=video&part=id&safeSearch=moderatetype=video&videoDuration=long&videoEmbeddable=true&q=${query}`;
  if (resultsPerPage) {
