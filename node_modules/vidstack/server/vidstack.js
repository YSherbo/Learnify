import { G as GroupedLog, L as List, a as ListSymbol, s as softResetMediaState, g as getTimeRangesEnd, b as getTimeRangesStart, T as TimeRange, m as mediaState } from './chunks/vidstack-Mo93DvBx.js';
import { D as DOMEvent, k as fscreen, V as ViewController, l as listenEvent, o as onDispose, m as signal, p as peek, i as isString, j as isNumber, n as createContext, u as useContext, C as Component, q as isDOMNode, r as isFunction, v as setAttribute, x as isTouchEvent, s as setStyle, y as autoUpdate, z as computePosition, A as flip, B as shift, F as effect, G as isKeyboardEvent, b as isArray, H as isKeyboardClick, e as deferredPromise, d as isUndefined, I as untrack, J as provideContext, K as animationFrameThrottle, L as uppercaseFirstChar, M as camelToKebabCase, N as computed, O as prop, P as method, t as tick, h as scoped, Q as noop, S as State, f as isNull, R as ariaBool$1, T as isWriteSignal, U as hasProvidedContext, W as isObject, X as useState, Y as createScope, Z as r, _ as wasEnterKeyPressed, $ as isPointerEvent, a0 as isMouseEvent, a1 as kebabToCamelCase, c as createDisposalBin } from './chunks/vidstack-D6OE36Wz.js';
export { a5 as appendTriggerEvent, a4 as findTriggerEvent, a2 as hasTriggerEvent, a3 as walkTriggerEventChain } from './chunks/vidstack-D6OE36Wz.js';
import { f as canOrientScreen, h as isTrackCaptionKind, T as TextTrackSymbol, j as TextTrack, k as isAudioSrc, p as preconnect, I as IS_CHROME, m as canChangeVolume, n as getRequestCredentials, e as isHLSSrc, d as isHLSSupported, b as isDASHSrc, w as watchActiveTextTrack, o as isCueActive } from './chunks/vidstack-B35u_Yz6.js';
export { A as AUDIO_EXTENSIONS, z as AUDIO_TYPES, D as DASH_VIDEO_EXTENSIONS, E as DASH_VIDEO_TYPES, H as HLS_VIDEO_EXTENSIONS, C as HLS_VIDEO_TYPES, V as VIDEO_EXTENSIONS, B as VIDEO_TYPES, F as canGoogleCastSrc, r as canPlayHLSNatively, u as canRotateScreen, s as canUsePictureInPicture, t as canUseVideoPresentation, x as findActiveCue, q as getDownloadFile, G as isMediaStream, i as isVideoSrc, v as parseJSONCaptionsFile, y as watchCueTextChange } from './chunks/vidstack-B35u_Yz6.js';
import { D as DASHProviderLoader, H as HLSProviderLoader, V as VideoProviderLoader } from './chunks/vidstack-Bzxr0VSL.js';
...
class VimeoProviderLoader {
  ...
  async loadPoster(src, ctx, abort) {
    const { resolveVimeoVideoId, getVimeoVideoInfo } = await import('./chunks/vidstack-BTBUzdbF.js');
    if (!isString(src.src))
      return null;
  ...
  async _requestGoogleCast(trigger) {
    try {
      ...
      if (!this._googleCastLoader) {
        const $module = await import('./chunks/vidstack-wueK4mRr.js');
